...
human interaction\is{social interaction} (see \citealt[10]{enfield_anatomy_2009}, \citeyear[Chapter 4]{enfield_relationship_2013}). In Figure \ref{iteratedpractice}, each link in the chain from 
...
The schema in Figure \ref{iteratedpractice} draws our attention to a set of bridges that a bit 
